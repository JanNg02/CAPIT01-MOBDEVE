...
class homeBOadapter(context: Context, private val items: List<currentAssignment>) : ArrayAdapter<currentAssignment>(context, android.R.layout.simple_list_item_1, items) {
