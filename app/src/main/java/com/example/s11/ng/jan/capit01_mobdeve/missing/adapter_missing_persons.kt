...
class MissingPersonAdapter(private val missingPersonData: List<missingPersonData>) :
    RecyclerView.Adapter<MissingPersonAdapter.MissingPersonViewHolder>() {
    ...
    inner class MissingPersonViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(missingPerson: missingPersonData, position: Int) {
